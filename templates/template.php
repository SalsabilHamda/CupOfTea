...
<html lang="fr">
    ...
    <body>
        <header>
            ...
            <div class="container">
                <div> <!--flex-->
                    <a href="index.php?action=accueil"><img src="public/img/logo.png" alt="Logo du site Cup Of Tea"></a>
                    <p class="panier">
                        <a href="index.php?action=shop"><span>Mon panier</span> <i class="fas fa-shopping-cart"></i> <strong>0€</strong></a>
                    </p>
                </div>
